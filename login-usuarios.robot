...
Acesso negado de usuário
    [Documentation]                 Obter acesso negado caso as credenciais sejam inválidas
    Open Browser                    ${URL}                chrome
    Input Text                      ${USERNAME_FIELD}     usuarioteste
    Input Password                  ${PASSWORD_FIELD}     SenhaTeste!
    Click Button                    ${LOGIN_BUTTON}      
